...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("LOOK");
    case mBTC: return QString("mLOOK");
    case uBTC: return QString::fromUtf8("μLOOK");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("LookCoins"));
    case mBTC: return QString(QObject::tr("Milli-LookCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-LookCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
